...
public partial class MainWindow : Window
{
    ...
    public MainWindow()
    {
        ...
        NewsTitleBox.Text = "Patch " + VersionBox.Text;
        NewsBodyBox.Text = "Manifest generated by PatchBuilder.";
        LoadLastSettings();
    ...
    private async void LoadMetadataButton_Click(object sender, RoutedEventArgs e)
    {
        try
        {
            ...
            NewsBodyBox.Text = firstNews?.Body ?? "Manifest updated by PatchBuilder.";
    ...
    private async void SaveMetadataButton_Click(object sender, RoutedEventArgs e)
    {
        try
        {
            ...
            var updatedManifest = new UpdateManifest
            {
                ...
                ExtraFilePolicy = extraFilePolicy,
                Launcher = launcherInfo,
                News = BuildNewsItems(version, _loadedManifest.News.FirstOrDefault())
            };
    ...
    private List<NewsItem> BuildNewsItems(string version, NewsItem? existing)
    {
        var title = string.IsNullOrWhiteSpace(NewsTitleBox.Text)
            ? "Patch " + version
            : NewsTitleBox.Text.Trim();
        var body = string.IsNullOrWhiteSpace(NewsBodyBox.Text)
            ? "Manifest updated by PatchBuilder."
            : NewsBodyBox.Text.Trim();
